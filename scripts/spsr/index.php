...
$result= gDom(file_get_contents('http://www.cpcr.ru/cgi-bin/postxml.pl?TARIFFCOMPUTE_2&ToCity='.$deliveryCity.'|0&FromCity='.$originalCity.'|0&Weight='.$wweight.'&Amount='.$value.'&GabarythB=1'));	
	printr('http://www.cpcr.ru/cgi-bin/postxml.pl?TARIFFCOMPUTE_2&ToCity='.$deliveryCity.'|0&FromCity='.$originalCity.'|0&Weight='.$wweight.'&Amount='.$value.'&GabarythB=1');
    vardump($result);	
